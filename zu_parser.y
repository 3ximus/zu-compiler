...
func : tTYPE tIDENTIFIER '(' list ')' fbdy		{ $$ = new zu::function_declaration_node(LINE, $2, $4); } /* probably shouldn't be list */
	 | '!' tIDENTIFIER '(' list ')'	fbdy		{ $$ = new zu::function_declaration_node(LINE, $2, $4); }
	 ;

fbdy : list										{ $$ = new zu:function_body_node(LINE, $1); }
	 ;
