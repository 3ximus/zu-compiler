// $Id: basic_ast_visitor.h,v 1.3 2016/03/17 17:58:35 ist169481 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_pointer_node(cdk::pointer_node * const node, int lvl) 	= 0;
...
public:
  virtual void do_function_slim_node(zu::function_slim_node * const node, int lvl) = 0;
