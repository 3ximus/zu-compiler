// $Id: xml_writer.h,v 1.5 2016/03/18 13:03:56 ist169481 Exp $ -*- c++ -*-
...
namespace zu {
	...
	class xml_writer: public basic_ast_visitor {
		...
		std::string type_name(basic_type * const node) {
			switch(node->name()) {
				case 1: return "int";
				case 2: return "double";
				case 8: return "string";
				case 16: return "pointer";
				case 0: return "void";
		...
		void ProcessZuType(basic_type * const node, int lvl) {
			std::string name = type_name(node);
