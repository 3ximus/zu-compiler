...
inline bool zu::type_checker::processBinaryRead(cdk::binary_expression_node * const node, int lvl) {
...
void zu::type_checker::do_add_node(cdk::add_node * const node, int lvl) {
	...
	if (processBinaryRead(node, lvl)) return;
...
void zu::type_checker::do_read_node(zu::read_node * const node, int lvl) {
	...
	/* TODO
	 * Currently being processed in processBinaryRead and assigment node
	 */
