...
namespace zu {
  ...
  public:
    inline function_body_node(int lineno, basic_type *zu_type, const char *s, bool isPublic, bool isImported, cdk::sequence_node *args, cdk::expression_node *literal, zu::block_node *block) :
       zu::function_declaration_node(lineno, zu_type, s, isPublic, isImported, args, literal), _block(block) {
    }

    inline function_body_node(int lineno, basic_type *zu_type, const std::string &s, bool isPublic, bool isImported, cdk::sequence_node *args, cdk::expression_node *literal, zu::block_node *block) :
       zu::function_declaration_node(lineno, zu_type, s, isPublic, isImported, args, literal), _block(block) {
    }
	...
	inline function_body_node(int lineno, zu::function_declaration_node *declaration, zu::block_node *block) :
